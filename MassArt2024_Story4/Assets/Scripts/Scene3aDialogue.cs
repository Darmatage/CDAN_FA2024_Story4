...
public class Scene3aDialogue : MonoBehaviour
{
    ...
    public void Next()
    {
        ...
        else if (primeInt == 42)
        {
            ...
            Char1speech.text = "";
            Char2name.text = "5H3RYL";
            Char2speech.text = "Interesting... anyway that's probably my daughter, D0TT13... WHO ISN'T SUPPOSED TO BE ON THE ROOF!";
            Char3name.text = "";
            Char3speech.text = "";
        }
        ...
        else if (primeInt == 52)
        {
            ...
            Char2speech.text = "";
            Char3name.text = "D0TT13";
            Char3speech.text = "She might as well have.";
        ...
        else if (primeInt == 57)
        {
            ...
            Char1speech.text = "";
            Char2name.text = "5H3RYL";
            Char2speech.text = "HEY! That was rude, go do homework";
            Char3name.text = "";
            Char3speech.text = "";
    ...
    {
        Char1name.text = playerName;
        Char1speech.text = "AAAAHHHHH!! The sky is falling!";
        Char2name.text = "";
        Char2speech.text = "";
        Char3name.text = "";
        Char3speech.text = "";
